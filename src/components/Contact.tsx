          ...
          <div className="flex flex-col gap-6">
              ...
              <div className="space-y-4 flex-1 flex flex-col justify-around">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">123 StayEase Avenue, Downtown District<br />New York, NY 10001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">support@stayease.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-xl border border-[#002650]/10">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 bg-[#002650] rounded-xl flex items-center justify-center hover:bg-[#003870] transition-all duration-300 transform hover:scale-110">
