      ...
      <div className="relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 relative inline-block">
            About Us
            <div
              className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 to-blue-400 transform origin-left transition-all duration-1000"
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-blue-100 transform -translate-x-1/2 hidden md:block overflow-hidden">
            <div
              className="absolute top-0 left-0 right-0 w-full bg-gradient-to-b from-blue-600 via-blue-500 to-blue-400 transition-all duration-1000 ease-out"
          ...
          <div className="space-y-20 w-full">
            ...
            >
              <div className="w-full md:w-[500px] bg-gradient-to-br from-white to-blue-50 p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-blue-100 relative z-10">
